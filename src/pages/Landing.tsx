...
const Landing = () => {
  return (
    <div className="min-h-screen flex items-center justify-center fluid-bg overflow-hidden">
      {/* Flowing gradient background shapes with updated earthtone palette */}
      <div 
      ...
      {/* Updated sage green gradient shape */}
      <div 
      ...
      {/* Updated earthy brown gradient shape */}
      <div 
      ...
      <div className="container relative z-10 max-w-2xl w-full px-4">
        ...
        <div className="glass-surface p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="glass-earth-orange p-6 rounded-xl hover:scale-[1.02] transition-transform">
            ...
            <div className="glass-earth-cream p-6 rounded-xl hover:scale-[1.02] transition-transform">
            ...
            <div className="glass-earth-sage p-6 rounded-xl hover:scale-[1.02] transition-transform">
            ...
            <div className="glass-earth-taupe p-6 rounded-xl hover:scale-[1.02] transition-transform">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/login">
              <Button className="w-full sm:w-auto gap-2 h-12 bg-gradient-to-r from-[#745641] to-[#bd8770] hover:opacity-90 transition-all shadow-md hover:shadow-lg backdrop-blur-md bg-white/10">
                Sign In
