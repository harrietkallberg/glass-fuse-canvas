    ...
    <Card className={`${colorClass} border-white/70 border overflow-hidden backdrop-blur-sm bg-white/30`}>
      ...
      <CardContent className="pb-2">
        ...
        <div className="flex gap-4 mt-4">
          {/* Curve visualization with adjusted height and padding */}
          <div className="w-1/2 h-[90px] bg-white/15 backdrop-blur-sm rounded-md overflow-hidden border border-white/40 mb-2">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={curveData} margin={{ top: 5, right: 0, left: 0, bottom: 10 }}>
                <defs>
